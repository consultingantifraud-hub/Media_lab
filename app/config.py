...
class Settings(BaseSettings):
    ...
    wavespeed_text_model: str = "ideogram-ai/ideogram-v2a-turbo"  # Модель для дизайнерского текста (Ideogram V2a Turbo - поддерживает inpainting для редактирования изображений)
