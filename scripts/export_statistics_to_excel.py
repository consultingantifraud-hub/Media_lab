...
MODEL_COSTS_USD = {
    ...
    "fal-ai/bytedance/seedream/v4/edit": 0.04,  # Обратная совместимость
    "fal-ai/bytedance/seedream/v4/text-to-image": 0.04,  # Обратная совместимость
    settings.fal_seedream_edit_model: 0.04,  # Текущая версия (v4.5)
    settings.fal_seedream_create_model: 0.04,  # Текущая версия (v4.5)
...
def get_model_by_operation_type(operation_type: str) -> str | None:
    ...
    "retouch": settings.fal_seedream_edit_model,  # Ретушь - используем Seedream модель ($0.04)
