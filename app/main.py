...
IMAGE_DESIGNER_TEXT_BUTTON = "🧩 Дизайнерский текст"
...
IMAGE_LIGHT_BUTTON = "Flux Ultra"  # Используется для выбора модели после "Создать"
...
def build_main_keyboard() -> ReplyKeyboardMarkup:
    buttons = [
        ...
        [KeyboardButton(text=IMAGE_DESIGNER_TEXT_BUTTON)],
...
def build_create_model_keyboard() -> ReplyKeyboardMarkup:
    ...
    buttons = [
        [KeyboardButton(text=IMAGE_STANDARD_BUTTON), KeyboardButton(text=IMAGE_LIGHT_BUTTON)],
        [KeyboardButton(text=IMAGE_SEEDREAM_CREATE_BUTTON)],
        [KeyboardButton(text=IMAGE_GPT_CREATE_BUTTON)],
        [KeyboardButton(text=INFO_BUTTON)],
    ]
    return ReplyKeyboardMarkup(
        keyboard=buttons,
